...
def iniciar_migracion():
    print("Iniciando Asistente de Migración (Solo Artículos)...")
    ...
    try:
        ...
        for art in articulos_viejos:
            ...
            # Rellena los campos nuevos de la versión actual que antes no existían
        ...
        conn_nueva.commit()
        print(f"✅ ¡Éxito! Se migraron {migrados_exito} artículos al nuevo Sistema de Inventario Escolar.")
